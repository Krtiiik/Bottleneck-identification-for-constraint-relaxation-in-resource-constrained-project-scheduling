...
\begin{figure}[t]
    ...
    \caption{
        ...
        The figure consists of three panels: scheduled job intervals panel
        and two resource panels, each corresponding to a specific resource in the project.
        All panels share a common x-axis denoting time in time periods.
        The job interval panel illustrates the arrangement of jobs in the schedule,
        where their y-positions were chosen arbitrarily.
        In each resource panel, the availability of the corresponding resource
        is illustrated by a gray step function
        and the consuming load is illustrated by a green step function.
        }
