...
\begin{figure}[p]
    ...
    \caption{
        ...
        Here, the left-shift closure of the job 9 is the set $\closure{9} = \{ 2, 3, 8, 9 \}$.
        ...
        Job 2 is included by \cref{def:closure/resource-precedence} --- resource predecessor of the job 8 on resource 1.
        Job 3 is included by \cref{def:closure/precedence} --- precedence predecessor of the job 8.
        }
